...
export class CoursesComponent implements OnInit, OnDestroy {
  ...
  dataSource = new MatTableDataSource<CourseItem>([]);
  selection = new SelectionModel<CourseItem>(true, []);
  isLoading = true;
  ...
  editCall(row: CourseItem) {
    this.openDialog('edit', row);
    console.log("TopicManager editCall", row);
  }

  openDialog(action: 'add' | 'edit', data?: CourseItem) {
  ...
  private updateRecord(updatedRecord: CourseItem) {
